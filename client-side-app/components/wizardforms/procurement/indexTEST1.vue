...
export default {
  data() {
    ...
    return {
      ruleForm: {
        supplier_number: '',
        company_email_address: 'che@gmail.com',
        step1: {
          full_name_organization: 'Jack',
          physical_address: 'NkJA',
          //
          postal_address: 'pO BOX',
          telephone_number: '018199121',
          kra_pin_no: 'AKJSJHS2',
          company_registration_no: '1212',
          //
          finance_dept_name: 'SAS',
          finance_dept_email: 'hey@gmail.com',
          finance_dept_telno: '0810813081',
          legal_entity: 'JLAS',
          legal_entity_other: 'ASKA',
          web_site_address: 'ASASDAS',
          //
          list: [
            {
              id: 1,
              name: 'Director 1',
              director_name: 'AKLS',
              director_email: 'chege@gmail.com',
              director_id_no: '1912',
              director_postal_address: 'asjjas',
              director_nationality: 'Kenya',
          ...
          details_of_interest: '',
          //
          contact_person_name: 'Jkas',
          contact_person_title: 'asjkj',
        },
        step2: {
          bank_references: {
            bank_name: 'IJAS',
          ...
          trade_references: [
            {
              id: 1,
              name: 'Reference 1',
              company_name_addr: 'chege@gmail.com',
              contact_person: 'lajsa',
              position: 'Web',
              office_telno: '09080',
              mobile_telno: '-12012',
              email_addr: 'chege@gmail.com',
            },
          ],
        },
        step3: {
